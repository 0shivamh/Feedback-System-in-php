...
$sql = "INSERT INTO feedback (Username,Email,Address,Branch,suggestions,improvement)
...
<input type="text" name="sname" required="" value="<?php echo $name; ?>"></div>
<br>
<div>
...
<br>
<div>
Branch:<input type="text" name="branch" required="" value="<?php echo $b; ?>"></div>
<br>
<div>
